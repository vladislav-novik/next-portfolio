      ...
      <div className="container">
        <div className="flex flex-col items-center">
          ...
          <div className="bg-gray-950 border border-gray-800 px-4 py-1.5 inline-flex items-center gap-4 rounded-lg">
            <div className="bg-green-600 size-2.5 rounded-full relative">
              <div className="bg-green-600 animate-ping-large rounded-full absolute inset-0"></div>
            </div>
        ...
        <div className="max-w-lg mx-auto">
          ...
          <p className="mt-4 text-center text-white/60 md:text-lg">
            ...
            minima sapiente explicabo vel voluptas, maxime nam. Expedita,
            voluptatibus voluptas dolor laudantium quia incidunt eveniet
            assumenda beatae qui. Neque, iure.
          </p>
        </div>
